...
def parse_arguments():
    ...
    parser.add_argument("--save_pairsfile", action="store_true",
                        help="set to True to save a file containing the paths of the retrieved images for"
                        "all queries. The number of candidates is always max(--recall_values).")
